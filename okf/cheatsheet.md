...
- `ds` deletes the focused stream and all descendants; `dS` deletes the focused stream and promotes its direct children one level. The confirmation modal states the selected behavior.
